document.addEventListener('DOMContentLoaded', () => {
    ...
    const productDetails = {
        1: {
            ...
            title: "Modern stand 1",
            meta: "Comfortable and stylish, perfect for any living room.",
            description: "This modern stand is made with high-quality materials and offers unparalleled comfort. Its modern design makes it a perfect addition to any living room.",
            features: ["High-quality fabric", "Durable frame", "Available in multiple colors", "Comfortable seating"]
        },
        2: {
            image: "../img/stand/stand (2).png",
            title: "Modern stand 2",
            meta: "Elegant and durable for everyday use.",
            description: "A stylish and elegant stand designed for maximum durability and style. Perfect for any modern home decor.",
